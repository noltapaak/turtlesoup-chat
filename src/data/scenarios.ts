...
export const scenarios: Scenario[] = [
  {
    ...
    image: 'https://via.placeholder.com/400x250?text=바다거북+수프'
  },
  {
    id: '2',
    title: '붉은 옷의 여자',
    ...
    rules: '스무고개 형식으로 진행합니다. 제가 드리는 답변은 "예", "아니오", 또는 "정답과 직접적인 관련은 없습니다." 세 가지입니다. 질문을 통해 단서를 얻어 사건의 전말을 맞춰보세요!\n\n예시 질문:\n- 여자는 실제 사람인가요?\n- 남자는 특정 직업을 가지고 있나요?',
    image: 'https://via.placeholder.com/400x250?text=붉은+옷의+여자'
  },
  {
    id: '3',
    title: '정전',
    ...
    rules: '스무고개 형식으로 진행합니다. 제가 드리는 답변은 "예", "아니오", 또는 "정답과 직접적인 관련은 없습니다." 세 가지입니다. 질문을 통해 단서를 얻어 사건의 전말을 맞춰보세요!\n\n예시 질문:\n- 남자는 엘리베이터에 혼자 있었나요?\n- 정전은 오랫동안 지속되었나요?',
    image: 'https://via.placeholder.com/400x250?text=정전'
  },
  {
    id: '4',
    title: '사막의 남자',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=사막의+남자',
  },
  {
    id: '5',
    title: '닫힌 문',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=닫힌+문',
  },
  {
    id: '6',
    title: '산장의 남자',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=산장의+남자',
  },
  {
    id: '7',
    title: '음악과 죽음',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=음악과+죽음',
  },
  {
    id: '8',
    title: '두 개의 알약',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다. 이 문제는 다양한 해석이 가능할 수 있습니다.',
    image: 'https://via.placeholder.com/400x250?text=두+개의+알약',
  },
  {
    id: '9',
    title: '자동차와 남자',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=자동차와+남자',
  },
  {
    id: '10',
    title: '밀실 살인',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=밀실+살인',
  },
  {
    id: '11',
    title: '전화 부스',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=전화+부스',
  },
  {
    id: '12',
    title: '숲 속의 오두막',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=숲+속의+오두막',
  },
  {
    id: '13',
    title: '엘리베이터 버튼',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=엘리베이터+버튼',
  },
  {
    id: '14',
    title: '건초더미',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=건초더미',
  },
  {
    id: '15',
    title: '두 명의 경비원',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=두+명의+경비원',
  },
  {
    id: '16',
    title: '유일한 생존자',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=유일한+생존자',
  },
  {
    id: '17',
    title: '톱밥',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=톱밥',
  },
  {
    id: '18',
    title: '수수께끼의 선물',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=수수께끼의+선물',
  },
  {
    id: '19',
    title: '사과와 남자',
    ...
    rules: '질문을 통해 단서를 얻어보세요. "예", "아니오", "관련 없음"으로 답변합니다.',
    image: 'https://via.placeholder.com/400x250?text=사과와+남자',
  },
  {
    id: '20',
    title: '마지막 비행',
    ...
    rules: '스무고개 형식으로 진행합니다. 제가 드리는 답변은 "예", "아니오", 또는 "정답과 직접적인 관련은 없습니다." 세 가지입니다. 질문을 통해 단서를 얻어 사건의 전말을 맞춰보세요!',
    image: 'https://via.placeholder.com/400x250?text=마지막+비행',
  },
]; 